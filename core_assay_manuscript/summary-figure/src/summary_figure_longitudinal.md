Combine Sup Table and extract overlap from the longitudinal analysis
================
Naresh Doni Jayavelu, Slim Fourati, Jingjing Qi
08 June, 2023
...
|:----------------------|:----------------------------------|:--------------------------------------------------------------------------|:---------------------------------------|----------:|:------------|:------------|
| NasalRNAseq\_mod3     | Olink\_mod0                       | regulation of cell migration (<GO:0030334>)                               | regulatory T cell/cytoPos              | 0.3173622 | Severe      | Mild        |
| NasalRNAseq\_mod4     | Olink\_mod2                       | negative regulation of cardiac muscle cell differentiation (<GO:2000726>) | endothelial cell of vascular tree/cell | 0.3535765 | Mild        | Severe      |
| NasalRNAseq\_mod5     | Olink\_mod2                       | Xenobiotic Metabolism                                                     | dendritic cell/cytoNeg                 | 0.3708514 | Mild        | Severe      |
| NasalRNAseq\_mod6     | Olink\_mod1                       | Hematopoietic cell lineage                                                | hematopoietic stem cell/cytoNeg        | 0.2351215 | Severe      | Severe      |
| NasalRNAseq\_mod3     | plasma\_proteomics\_targeted.mod4 | ECM-receptor interaction                                                  | XENOBIOTIC\_METABOLISM                 | 0.5773810 | Severe      | Severe      |
| NasalRNAseq\_mod4     | plasma\_proteomics\_targeted.mod0 | proteolysis (<GO:0006508>)                                                | COAGULATION                            | 0.5782828 | Mild        | Mild        |
...
```
    ...
    ## Warning in 362:370:377: numerical expression has 9 elements: only the first used
...
![](../output/heatmap-longitudinal-1.png)<!-- -->
