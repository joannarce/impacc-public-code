Nasal Metagenomic Univariate Analysis
================
06 June, 2023
...
### Misc
run_NMDS_fresh = FALSE   # Set this value to TRUE if you haven't already calculated "Nasal_NMDS_k3_immportIds.RData".
...
![](nasal_metagenomics_files/figure-gfm/panel-a-output-gen-1.png)<!-- -->
...
![](nasal_metagenomics_files/figure-gfm/panel-b-output-gen-1.png)<!-- -->
...
![](nasal_metagenomics_files/figure-gfm/panel-c-output-gen-1.png)<!-- -->
...
![](nasal_metagenomics_files/figure-gfm/panel-d-output-gen-1.png)<!-- -->
...
![](nasal_metagenomics_files/figure-gfm/panel-e-output-gen-1.png)<!-- -->
...
![](nasal_metagenomics_files/figure-gfm/panel-f-output-gen-1.png)<!-- -->
...
![](nasal_metagenomics_files/figure-gfm/sup-panel-a-output-gen-1.png)<!-- -->
...
![](nasal_metagenomics_files/figure-gfm/sup-panel-b-output-gen-1.png)<!-- -->
...
![](nasal_metagenomics_files/figure-gfm/sup-panel-c-output-gen-1.png)<!-- -->
...
```
    ...
    ## [16] pals_1.7             vegan_2.6-4          lattice_0.20-41     
    ...
    ## [28] ggbeeswarm_0.6.0     ggplot2_3.4.0        pvca_0.1.0          
    ## [31] ggeffects_1.1.3      qvalue_2.22.0        ordinal_2019.12-10  
    ## [34] gamm4_0.2-6          mgcv_1.8-31          nlme_3.1-148        
    ## [37] lme4_1.1-27.1        Matrix_1.2-18        knitr_1.39          
    ## 
    ## loaded via a namespace (and not attached):
    ##  [1] readxl_1.3.1        backports_1.2.0     circlize_0.4.13    
    ##  [4] plyr_1.8.6          splines_4.0.2       digest_0.6.27      
    ...
    ## [19] xfun_0.31           crayon_1.4.1        jsonlite_1.7.2     
    ## [22] glue_1.6.2          gtable_0.3.0        GetoptLong_1.0.5   
    ## [25] car_3.0-11          shape_1.4.6         BiocGenerics_0.36.1
    ## [28] maps_3.3.0          abind_1.4-5         scales_1.2.1       
    ## [31] DBI_1.1.1           rstatix_0.7.0       Rcpp_1.0.8         
    ## [34] clue_0.3-59         bit_4.0.4           foreign_0.8-80     
    ...
    ## [64] beeswarm_0.4.0      curl_4.3            png_0.1-7          
    ## [67] ggsignif_0.6.2      reprex_2.0.0        stringi_1.5.3      
    ## [70] highr_0.8           nloptr_1.2.2.2      vctrs_0.6.2        
    ## [73] pillar_1.7.0        lifecycle_1.0.3     GlobalOptions_0.1.2
    ## [76] ucminf_1.1-4        data.table_1.14.0   insight_0.18.2     
    ## [79] R6_2.5.0            rio_0.5.27          vipor_0.4.5        
    ## [82] IRanges_2.24.1      codetools_0.2-16    dichromat_2.0-0    
    ## [85] boot_1.3-25         MASS_7.3-51.6       assertthat_0.2.1   
    ## [88] rjson_0.2.20        withr_2.5.0         S4Vectors_0.28.1   
    ## [91] hms_1.1.0           minqa_1.2.4         rmarkdown_2.9      
    ## [94] carData_3.0-4       Cairo_1.5-12.2      numDeriv_2016.8-1.1
    ## [97] lubridate_1.7.10
